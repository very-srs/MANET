...
# protoc: regenerate ONLY with protoc 3.21.x (libprotoc 3.21.12) — its output
# matches the protobuf runtime shipped on the live MANET nodes (4.21.12).
# Newer protoc adds a `runtime_version` import/check that does not exist on
# that runtime; older protoc (<3.19) output is rejected by it entirely.
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _NODEINFO._serialized_end=1173
  _NODEINFO_GPSLOCATION._serialized_start=920
  _NODEINFO_GPSLOCATION._serialized_end=988
  _NODEINFO_CHANNELSCANRESULT._serialized_start=990
  _NODEINFO_CHANNELSCANRESULT._serialized_end=1066
  _NODEINFO_CHANNELREPORT._serialized_start=1068
  _NODEINFO_CHANNELREPORT._serialized_end=1129
  _NODEINFO_NODESTATE._serialized_start=1131
  _NODEINFO_NODESTATE._serialized_end=1173
