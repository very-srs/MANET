...
|------|------------|------|------|
| M.2 M Key to A + E Key Adapter | Particularly short adapter that reduces wasted space; converts M-key M.2 slot for WiFi card use | $4.13 | [aliexpress](https://www.aliexpress.us/item/2255799988809135.html) |
| Radxa ROCK 3A RK3568 | 4-core, 4GB RAM SBC (Raspberry Pi form factor) with two M.2 slots | $64.97 | [aliexpress](https://www.aliexpress.us/item/3256807319736584.html) |
| Radxa eMMC Module & SPI Flash Module | eMMC storage module; order the cheapest available (64GB used here) | $30.00 | [arace](https://arace.tech/products/emmc-module) |
| M.2 NVMe SSD Extension Cable (Model B) | Pair of right-angle ribbon cables for relocating M-key M.2 slot (includes extra) | $18.98 | [aliexpress](https://www.aliexpress.us/item/3256808934277761.html) |
| AW7916-AED Wi-Fi 6E AX3000 M.2 A/E Key Module | Dual-band, dual concurrent 3x3 802.11ax WiFi module (E-key) | $32.00 | [asiarf](https://asiarf.com/product/wi-fi-6e-m-2-ae-key-module-mt7916-aw7916-aed/) |
...
| Name | Description | Cost | Link |
|------|------------|------|------|
| U.FL IPX to RP-SMA Female Pigtail Coax Cable (5pcs) | Connects WiFi card to external antennas | $8.99 | [amazon](https://www.amazon.com/dp/B093247PHX) |
| Dual Band WiFi 2.4/5/5.8GHz 8dBi MIMO RP-SMA Antennas (4-Pack) | Generic antennas for 802.11ax card | $11.99 | [amazon](https://www.amazon.com/dp/B07W4T7HX2) |
| 915MHz LoRa Antenna 3dBi Omni SMA Male | Generic 915MHz antenna (HaLow use) | $9.99 | [amazon](https://www.amazon.com/dp/B0CTXKBMH9) |
...
| Female-to-Female Dupont Jumper Wires (40pcs, 20cm) | Wiring for connections; plan quantity if building multiple units | $3.99 | [amazon](https://www.amazon.com/dp/B0BRTJQGS6) |
...
| Name | Description | Cost | Link |
|------|------------|------|------|
| Standoffs (ROCK 3A ↔ PiSugar) | Mounting standoffs between boards | $1.00 | [mouser](https://www.mouser.com/ProductDetail/Essentra/R907-2?qs=PzGy0jfpSMvcOhESiy%252BfEg%3D%3D) |
...
| Case heatsink | SK 665 75 SA | $9 | not currently set |
